...
.swiper-pagination{position:absolute;text-align:center;z-index:10;bottom:var(--swiper-pagination-bottom,8px);left:0;width:100%}.swiper-pagination-bullet{display:inline-block;width:var(--swiper-pagination-bullet-size,8px);height:var(--swiper-pagination-bullet-size,8px);border-radius:50%;background:var(--swiper-pagination-bullet-inactive-color,#fff);opacity:var(--swiper-pagination-bullet-inactive-opacity,.2);margin:0 calc(var(--swiper-pagination-bullet-gap,8px)/2);cursor:pointer;transition:opacity .2s}.swiper-pagination-bullet-active{opacity:1;background:var(--swiper-pagination-color,#fff)}.swiper-pagination-fraction{color:var(--swiper-pagination-fraction-color,#fff)}.swiper-pagination-progressbar{position:absolute;left:0;top:0;width:100%;height:var(--swiper-pagination-progressbar-size,4px);background:rgba(255,255,255,.25)}.swiper-pagination-progressbar .swiper-pagination-progressbar-fill{position:absolute;left:0;top:0;width:100%;height:100%;transform:scale(0);transform-origin:left top;background:var(--swiper-pagination-color,#fff);transition:transform .3s ease}
...
export function injectSwiperStyles(): void {
  if (typeof document === "undefined") return;
  if (document.getElementById("__swiper-gallery-css")) return;
