...
export function InteractionRow({ interaction, index, onChange, onRemove }: InteractionRowProps) {
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="grid gap-1">
            ...
            <Input
              ...
              onChange={(e) => {
                const action = interaction.actions[0] as {
                  type: "setState";
                  key: string;
                  value: unknown;
                };
                onChange({
                  ...interaction,
                  actions: [
                    { type: "setState" as const, key: e.target.value, value: action?.value ?? "" },
                  ],
                });
              }}
            />
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                onChange({
                  ...interaction,
                  actions: [
                    { type: "setState" as const, key: action?.key ?? "", value: e.target.value },
                  ],
                });
              }}
            />
